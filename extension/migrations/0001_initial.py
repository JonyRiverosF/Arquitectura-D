# Generated by Django 4.2.1 on 2023-11-23 00:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('id_area', models.AutoField(primary_key=True, serialize=False, verbose_name='id Area conocimiento')),
        ...
        migrations.CreateModel(
            name='clase',
            fields=[
                ('id_clase', models.AutoField(primary_key=True, serialize=False, verbose_name='id clase')),
                ...
                ('area_id_area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='extension.area_conocimiento')),
            ],
        ),
        migrations.CreateModel(
            name='nivel_academico',
            fields=[
                ('id_nivel', models.AutoField(primary_key=True, serialize=False, verbose_name='id nivel academico')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documentacion', models.ImageField(blank=True, null=True, upload_to='Foto Documentacion')),
                ('respuesta', models.CharField(max_length=250, verbose_name='respuesta usuario')),
                ('area_id_area', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='extension.area_conocimiento')),
                ('nivel_id_nivel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='extension.nivel_academico')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clase_id_clase', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='extension.clase')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='extension.usuario'),
        ),
    ]
